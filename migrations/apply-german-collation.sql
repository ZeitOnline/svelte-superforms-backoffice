-- Migration for German phonebook collation used by Wortiger and Wortgeflecht
-- word ordering on an existing local database.
-- This intentionally removes the old read views because the app now reads
-- directly from the base tables using database collation for ordering.
